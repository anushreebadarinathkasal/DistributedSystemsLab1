...
public class WorkerThread implements Runnable {
	...
	//this metod is used to write to the server.
		...
		try {
			...
			while (true) {
				...
				if (data.equals("POLL")) {
					...
					// This is used to send the destination client the message from the source client.
					//Basically to handle 1 to 1 messages
					String destinationClientName = data.split(":")[0];
					String destinationMsg = data.split(":")[1];
					WorkerThread destWorkerThread = this.server.getClient(destinationClientName);
					destWorkerThread.messages.add(this.clientName + " :1 to 1: " + destinationMsg);
				}
